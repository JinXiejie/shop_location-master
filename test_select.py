...
test_correct_res = pd.read_csv('merge_data/result-merge-9202-B9142.csv')
test_r1 = pd.read_csv('merge_data/result_11_11-2-9157.csv')
test_r2 = pd.read_csv('merge_data/result_11_10_temp_isconnect-9155.csv')
test_r3 = pd.read_csv('merge_data/result-merge_by_9200-9179-B9122.csv')
test_r4 = pd.read_csv('merge_data/result-iter=100-9116.csv')
test_r5 = pd.read_csv('merge_data/result-merge-9202.csv')
test_r6 = pd.read_csv('merge_data/result_11_11-4-9157.csv')
